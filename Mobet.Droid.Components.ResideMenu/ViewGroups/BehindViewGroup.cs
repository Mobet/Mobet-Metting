...
{
    public sealed class BehindViewGroup : ViewGroup
    {
        private new const string Tag = "BehindViewGroup";
        private readonly Paint fadePaint = new Paint();
        private const int MARGIN_THRESHOLD = 48;

        private ICanvasTransformer transformer;
        ...
        private int SelectorTop
        {
            get
            {
                ...
                y += (SelectedView.Height - selectorDrawable.Height) / 2;
                return y;
            }
        }
        ...
        private Drawable secondaryShadowDrawable;

        private MenuMode mode;
        private Bitmap selectorDrawable;

        public BehindViewGroup(Context context)
            : this(context, null)
        {
        }
        public BehindViewGroup(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
        ...
        public AboveViewGroup AboveView { get; set; }
        ...
        protected override void DispatchDraw(Canvas canvas)
        {
            ...
            {
                canvas.Save();
                transformer.TransformCanvas(canvas, AboveView.PercentOpen);
        ...
        protected override void OnMeasure(int widthMeasureSpec, int heightMeasureSpec)
        {
            ...
            var contentWidth = GetChildMeasureSpec(widthMeasureSpec, 0, width - widthOffset);
        ...
        public MenuMode Mode
        {
            ...
            set
            {
                if (value == MenuMode.Left || value == MenuMode.Right)
                {
                    ...
                    if (secondaryContent != null)
                        secondaryContent.Visibility = ViewStates.Invisible;
                }
                mode = value;
            }
        }
        ...
        {
            get { return secondaryShadowDrawable; }
            set
            {
                secondaryShadowDrawable = value;
                Invalidate();
            }
        }
        ...
        public void DrawFade(View content, Canvas canvas, float openPercent)
        {
            ...
            switch (Mode)
            {
                ...
                case MenuMode.LeftRight:
                    left = content.Left - BehindWidth;
                    right = content.Left;
                    canvas.DrawRect(left, 0, right, Height, fadePaint);
                    left = content.Right;
                    right = content.Right + BehindWidth;
                    break;
            }
        ...
        public View SelectedView
        {
            ...
            set
            {
                ...
                {
                    selectedView.SetTag(Resource.Id.selected_view, null);
                    selectedView = null;
                }
                if (value != null && value.Parent != null)
                {
                    selectedView = value;
                    selectedView.SetTag(Resource.Id.selected_view, Tag + "SelectedView");
                    Invalidate();
                }
            }
        }
        ...
        {
            get { return selectorDrawable; }
            set
            {
                selectorDrawable = value;
